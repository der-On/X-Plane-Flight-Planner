...
export const ADD_GPS_WAYPOINT = 'ADD_GPS_WAYPOINT';
...
export const SIDEBAR_CONTEXT_DEFAULT = SIDEBAR_CONTEXT_WAYPOINTS;
...
export const FLIGHT_PLAN_COLOR_DEFAULT = FLIGHT_PLAN_COLORS[0];
